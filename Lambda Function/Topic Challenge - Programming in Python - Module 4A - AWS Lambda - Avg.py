...
config file:
[default]
region = ca-central-1 (or whatever region you created function in)
"""
import json
import boto3
...
response = lambda_client.invoke(FunctionName="Avg", Payload=json.dumps(p))
...
print(f"Avg of nums {payload['nums']} is: {float(payload['avg']):.3f}")
